...
-- Insert products
INSERT OR IGNORE INTO products (id, name, description, price, category_id)
VALUES
  (1, 'Java 7th Edition', 'A book about Java Programming Language', 42.50, 1),
  (2, 'Headphones', 'Over-ear headphones', 199.99, 2);
